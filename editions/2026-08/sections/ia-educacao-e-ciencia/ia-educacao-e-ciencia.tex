...
\subtitle{Outra visão}
    \hspace{1cm}Por outro lado, por mais que a IA tenha recebido várias críticas, pesquisadores da educação em ciência têm dedicado seu tempos para entender como
...
Da mesma forma, percebeu-se que os chatbots de IA impulsionam a confiança do usuário, e por meio da reafirmação, diminuem seus índices de ansiedade e insegurança.
 Essa observação uma \textbf{implicação ética da IA na educação}, já que estimula uma maior vontade de estudo.
